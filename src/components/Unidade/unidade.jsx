...
import unidade3 from '../../assets/Unidade3.png'
...
export default function Unidade(){
  return(
    <div className="container-unidade">
      ...
      <div className="description-unidade">

          <img 
          width={250}
          className='img1' src={unidade2} alt="" />
          <img 
          width={250}
          className='img2' src={unidade1} alt="" />
          <img 
          width={250}
          className='img3' src={unidade3} alt="" />          

      </div>

     
      <div className="redes-sociais-unidade">
